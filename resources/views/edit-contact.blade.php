...
<body>
    ...
    <form method="POST" action="/contact/{{$contact->id}}" class="max-w-sm mx-auto absolute w-[50%] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
        @csrf
        @method('PUT')
        <p class="text-xl font-semibold mb-2"> Edit Contact</p>
        <div class="mb-5">
            <label class="block mb-2 text-sm font-medium text-gray-900 ">Name</label>
            <input type="text" name="name"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                placeholder="" value="{{ $contact->name }}" required />
        </div>
        ...
        <div class="mb-5">
            ...
            <input type="text" name="company"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                placeholder="" value="{{$contact->company}}" required />
        </div>
        ...
        <div class="mb-5">
            ...
            <input type="text" name="phone"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                placeholder="" value="{{$contact->phone}}"  required />
        </div>
        ...
        <div class="mb-5">
            ...
            <input type="email" name="email"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                placeholder="" value="{{$contact->email}}"  required />
        </div>
